...
var employee_tracker = function () {
    inquirer.prompt([{
        ...
        // prompt user to view all departments
        if (answers.prompt === 'View All Departments') {
            ...
            inquirer.prompt([{
                ...
                // insert user's input for department into database
            }]).then((answers) => {
            ...
            db.query(`SELECT * FROM department`, (err, result) => {
                ...
                inquirer.prompt([
                    ...
                    // Completing the comparison and putting the result in the variable
                    for (var i = 0; i < result.length; i++) {
            ...
            db.query(`SELECT * FROM employee, role`, (err, result) => {
                ...
                inquirer.prompt([
                    ...
                    {
                        // Updating employee to a new role
                        type: 'list',
                        name: 'role',
            ...
            // prompt user to log out after they are done
